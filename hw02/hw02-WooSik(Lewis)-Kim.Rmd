...
**Calculating the correlation coefficients between EFF and all the variables used in the EFF formula (in order of PTS, REB, STL, AST, BLK, Missed_FT, Missed_FG, TO, GP), and adding them to the vector "corr_coeff":**
...
• The relationship between efficiency and salary for all players does not seem to be very strong.
